...
function initializeBookChatAnimation() {
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', (e) => {
            ...
            // Calculate formatted meeting end time string
            ...
            if (calGuestPhoneWho) calGuestPhoneWho.textContent = `Phone: ${phone}`;
            ...
            // 3. Native ICS File Download Generator
            ...
            if (calIcsBtn) {
                calIcsBtn.onclick = () => {
                    ...
                    const icsContent = [
                        'BEGIN:VCALENDAR',
                        'VERSION:2.0',
                        'PRODID:-//Vishwajeet SRK//Chat Scheduling//EN',
                        'CALSCALE:GREGORIAN',
                        'METHOD:REQUEST',
                        'BEGIN:VEVENT',
                        `UID:booking-${Date.now()}@vishwajeet.portfolio`,
                        `DTSTAMP:${nowIso}`,
                        `DTSTART:${startIso}`,
                        `DTEND:${endIso}`,
                    ...
                    downloadLink.setAttribute('download', `Chat-with-Vishwajeet.ics`);
